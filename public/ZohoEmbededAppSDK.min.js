    ...
    embeddedApp: {
      ...
      init: function () {
        if (!h) {
          ...
          for (var t in l) c.getContext().Event.Listen(t, l[t])
        }
        return n
      },
    },
      ...
      return {
        ACTION: {
          setConfig: function (a) {
            return b({ category: 'ACTION', type: 'CUSTOM_ACTION_SAVE_CONFIG', object: a })
          },
          enableAccountAccess: function (a) {
            return b({ category: 'ACTION', type: 'ENABLE_ACCOUNT_ACCESS', object: a })
          },
        },
        FUNCTIONS: {
          execute: function (a, d) {
            ...
            d.auth_type = 'oauth'
            e.data = d
            return b({ category: 'FUNCTIONS_EXECUTE', customFunctionName: a, data: e })
          },
        },
        CONFIG: {
        ...
        API: {
          ...
          getRecord: function (a) {
            return b({
              category: 'READ',
              APIData: { Entity: a.Entity, RecordID: a.RecordID, RelatedList: void 0 },
            })
          },
          getBluePrint: function (a) {
            return l({ Entity: a.Entity, RecordID: a.RecordID, action: 'GET_BLUEPRINT_STATUS' })
          },
          ...
          updateRecord: function (a) {
            var d = a.Entity,
              e = a.APIData
            e.trigger = a.Trigger
            return b({ category: 'UPDATE', type: 'RECORD', Entity: d, APIData: e })
          },
          deleteRecord: function (a) {
            return b({ category: 'DELETE', type: 'RECORD', Entity: a.Entity, RecordID: a.RecordID })
          },
          ...
          updateProfile: function (a) {
            return b({ category: 'UPDATE', type: 'PROFILE', ID: a.ID, APIData: a.APIData })
          },
        ...
        UI: {
          ...
          Record: {
            open: function (a) {
              a = {
                action: { record: 'OPEN' },
                data: { Entity: a.Entity, RecordID: a.RecordID, target: a.Target },
              }
              return g(a)
            },
            edit: function (a) {
...
var ZSDKUtil = (function (c) {
    ...
    l.prototype.Error = function () {
      ;(c.isDevMode() || c.isLogEnabled()) && window.console.error.apply(null, arguments)
    }
    c.GetQueryParams = h
  ...
  ZSDKMessageManager = (function (c) {
        ...
        if (m)
          switch (k) {
            case 'FRAMEWORK.EVENT':
              ...
              w && 'function' === typeof w
                ? w(e, f)
                : ZSDKEventManager.NotifyEventListeners(g.AppContext, f.eventName, f.data)
              break
            default:
    ...
    function n(a, b) {}
    function b(a, b) {
      m(b.promiseid, !0, b.data)
    }
    function t(a, b) {
      m(b.promiseid, !1, b.data)
    }
    function m(a, b, d) {
      k.hasOwnProperty(a) && (b ? k[a].resolve(d) : k[a].reject(d), (k[a] = void 0), delete k[a])
    }
    function y(a) {
      return new Promise(function (b, d) {
        k[a] = { resolve: b, reject: d, time: new Date().getTime() }
      })
    }
    function v(b) {
    ...
    c.Init = function (a, b) {
      ...
      if (b && 'object' !== typeof b) throw Error('Invalid Configuration Passed to MessageManager')
      g = a
      return l.bind(c)
    }
    c.RegisterApp = function () {
      var a = { type: 'SDK.EVENT', eventName: 'REGISTER', appOrigin: encodeURIComponent(p()) }
      window.parent.postMessage(a, g.QueryParams.serviceOrigin)
    }
    c.DERegisterApp = function () {
      var a = { type: 'SDK.EVENT', eventName: 'DEREGISTER', uniqueID: g.getUniqueID() }
      v(a)
    }
  ...
  ZSDKEventManager = (function (c) {
    ...
    c.AttachEventListener = function (c, b) {
      'function' === typeof b && (Array.isArray(h[c]) || (h[c] = []), h[c].push(b))
    }
    c.NotifyEventListeners = function (c, b, t) {
      var m = b.match(/^\__[A-Za-z_]+\__$/gi)
      Array.isArray(m)
      if ((m = h[b]) && Array.isArray(m)) for (b = 0; b < m.length; b++) m[b].call(c, t)
...
function ZSDK() {
  ...
  function n(a, b, d) {
    return ZSDKMessageManager.TriggerEvent(a, b, d)
  }
  function b(a) {
